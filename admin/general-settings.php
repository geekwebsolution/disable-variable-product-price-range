    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <div class="wdvppr-price-range">
                ...
                <div class="wdvppr-label wdvppr-price-type">
                    <span class="wdvppr-radio-field">
                        ...
                        <label for="default"><?php echo esc_html("Default", 'disable-variable-product-price-range'); ?> <code><del><?php echo esc_html("Reguler Price", 'disable-variable-product-price-range'); ?></del> <?php echo esc_html("From: Sale PriceFrom: Sale Price", 'disable-variable-product-price-range'); ?></code></label>
                    </span>
                    <span class="wdvppr-radio-field">
                        ...
                        <label for="min"><?php echo esc_html("Minimum Price", 'disable-variable-product-price-range'); ?></label>
                    </span>
                    <span class="wdvppr-radio-field">
                        ...
                        <label for="max"><?php echo esc_html("Maximum Price", 'disable-variable-product-price-range'); ?></label>
                    </span>
                    <span class="wdvppr-radio-field">
                        ...
                        <label for="min_to_max"><?php echo esc_html("Minimum to Maximum Price", 'disable-variable-product-price-range'); ?></label>
                    </span>
                    <span class="wdvppr-radio-field">
                        ...
                        <label for="max_to_min"><?php echo esc_html("Maximum to Minimum Price", 'disable-variable-product-price-range'); ?></label>
                    </span>
                    <span class="wdvppr-radio-field">
                        ...
                        <label for="list_all_variation"><?php echo esc_html("List All Variation", 'disable-variable-product-price-range'); ?></label>
                    </span>
                    <span class="wdvppr-radio-field">
                        ...
                        <label for="custom_text"><?php echo esc_html("Custom Text", 'disable-variable-product-price-range'); ?></label>
                    </span>
                </div>
            </div>
            ...
            <div class="wdvppr-price-range wdvppr-change-label" style="<?php esc_attr_e($change_label_style); ?>">
                <div class="wdvppr-title">
                    <strong><?php _e('Change Label', 'disable-variable-product-price-range'); ?></strong> 
                </div>
            ...
            <div class="wdvppr-price-range wdvppr-custom-text" style="<?php esc_attr_e($custom_text_style); ?>">
                <div class="wdvppr-title">
                    <strong><?php _e('Custom Text', 'disable-variable-product-price-range'); ?></strong>
                </div>
                <div class="wdvppr-label">
            ...
            <div class="wdvppr-price-range wdvppr-add-from" style="<?php esc_attr_e($add_from_style); ?>">
                <div class="wdvppr-title">
                    <strong><?php _e('Add From', 'disable-variable-product-price-range'); ?></strong> 
                </div>
                <div class="wdvppr-label">
            ...
            <div class="wdvppr-price-range wdvppr-up-to" style="<?php esc_attr_e($up_to_style); ?>">
                <div class="wdvppr-title">
                    <strong><?php _e('Add Up To', 'disable-variable-product-price-range'); ?></strong> 
                </div>
                <div class="wdvppr-label">
                    <label class="wdvppr-switch">
            ...
            <div class="wdvppr-price-range">
                <div class="wdvppr-title">
                    <strong><?php _e('Variation Price', 'disable-variable-product-price-range'); ?></strong> 
                </div>
                <div class="wdvppr-label">
                    <label class="wdvppr-switch">
                    ...
                    <p><i><?php echo esc_html("Change price, based on selected variation(s).", 'disable-variable-product-price-range'); ?></i></p>
                </div>
            </div>

            <div class="wdvppr-price-range">
                <div class="wdvppr-title">
                    <strong><?php _e('Hide Default Price', 'disable-variable-product-price-range'); ?></strong> 
                </div>
                <div class="wdvppr-label">
                    <label class="wdvppr-switch">
                    ...
                    <p><i><?php echo esc_html("Don't display default variation price.", 'disable-variable-product-price-range'); ?></i></p>
                </div>
            </div>

            <div class="wdvppr-price-range">
                <div class="wdvppr-title">
                    <strong><?php _e('Hide Reset Link', 'disable-variable-product-price-range'); ?></strong>
                </div>
                <div class="wdvppr-label">
                    <label class="wdvppr-switch">
                    ...
                    <p><i><?php echo esc_html('Remove "Clear" link on single product page.', 'disable-variable-product-price-range'); ?></i></p>
                </div>
            </div>

            <div class="wdvppr-price-range wdvppr-format-sale-price" style="<?php esc_attr_e($format_sale_style); ?>">
                <div class="wdvppr-title">
                    <strong><?php _e('Format Sale Price', 'disable-variable-product-price-range'); ?></strong>
                </div>
                <div class="wdvppr-label">
                    <label class="wdvppr-switch">
                    ...
                    <p><i><?php echo esc_html("Show Regular Price and Sale Price Format.", 'disable-variable-product-price-range'); ?> <b>For Example:</b> <code>From <del>$40</del> $38 </code></i></p>
                </div>
            </div>

            <div class="wdvppr-price-range">
                <div class="wdvppr-title">
                    <strong><?php _e('Display Condition', 'disable-variable-product-price-range'); ?></strong>
                </div>
                <div class="wdvppr-label">
                    <select class="wdvppr-regular-ele-width display_condition" name="wdvppr_options[display_condition]">
                        <option value="shop" <?php selected( $display_condition, 'shop' ); ?>><?php echo esc_html("Shop/Archive Page", 'disable-variable-product-price-range'); ?> </option>
                        <option value="single" <?php selected( $display_condition, 'single' ); ?>><?php echo esc_html("Single Product/Product Description Page", 'disable-variable-product-price-range'); ?> </option>
                        <option value="both" <?php selected( $display_condition, 'both' ); ?>><?php echo esc_html("Both Shop and Single Product Page", 'disable-variable-product-price-range'); ?></option>
                    </select>
                </div>
            </div>
            ...
            <div class="wdvppr-price-range wdvppr-sku-with-variation-name" style="<?php esc_attr_e($sku_with_variation_style); ?>">
                <div class="wdvppr-title">
                    <strong><?php _e('SKU with variation name', 'disable-variable-product-price-range'); ?></strong>
                </div>
                <div class="wdvppr-label">
                    <label class="wdvppr-switch">
                    ...
                    <p><i><b><?php echo esc_html("For Example:", 'disable-variable-product-price-range'); ?></b> <code>Hoodie – Blue, Yes (woo-hoodie-blue-logo) – <del>$40.00</del> $38.00</code>.</i></p>
                </div>
            </div>

            <div class="wdvppr-price-range">
                <div class="wdvppr-title">
                    <strong><?php _e('Display discount badge', 'disable-variable-product-price-range'); ?></strong>
                </div>
                <div class="wdvppr-label">
                    <label class="wdvppr-switch">
                    ...
                    <p><i><b>Note:</b> <?php echo esc_html("This option will also work with", 'disable-variable-product-price-range'); ?> <b><?php echo esc_html("List all variation price.", 'disable-variable-product-price-range'); ?></b></i></p>
                </div>
            </div>

            <div class="wdvppr-price-range">
                <div class="wdvppr-title">
                    <strong><?php _e('Disable Price for Admin', 'disable-variable-product-price-range'); ?></strong>
                </div>
                <div class="wdvppr-label">
                    <label class="wdvppr-switch">
                    ...
                    <p><i><b>Note:</b> <?php echo esc_html("By enabling this option, Admin can see the default price range while logged in.", 'disable-variable-product-price-range'); ?></i></p>
                </div>
            </div>

            <div class="wdvppr-price-range">
                <div class="wdvppr-title">
                    <strong><?php _e('Product Wrapper Class', 'disable-variable-product-price-range'); ?></strong>
                </div>
                <div class="wdvppr-label">
                    ...
                    <p><i><?php echo esc_html("Keep blank, if you haven't any issues with the price changing. This field is for fixing price changing compatibility issue.", 'disable-variable-product-price-range'); ?></i></p>
                </div>
            </div>

            <div class="wdvppr-price-range">
                <div class="wdvppr-title">
                    <strong><?php _e('Remove Price Class', 'disable-variable-product-price-range'); ?></strong>
                </div>
                <div class="wdvppr-label">
                    ...
                    <p><i><?php echo esc_html("Keep blank, if you haven't any issues with the price changing. This field is for fixing price changing compatibility issue in the product description/singe product page.", 'disable-variable-product-price-range'); ?></i></p>
                </div>
            </div>
